...
public class CRC24 {
    ...
    public static byte[] toByteArray(int result){return new byte[]{(byte)((result>>16)&0xFF),(byte)((result>>8)&0xFF),(byte)(result&0xFF)};}
    ...
    public static void checknumGen(byte[] data){
        ...
        data[data.length-3]=res[0];data[data.length-2]=res[1];data[data.length-1]=res[2];
        res = null;
    }
